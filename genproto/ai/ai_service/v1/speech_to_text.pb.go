...
type SpeechToTextStreamConfiguration struct {
	...
	EndOfTurnConfidenceThreshold float64 `protobuf:"fixed64,3,opt,name=end_of_turn_confidence_threshold,json=endOfTurnConfidenceThreshold,proto3" json:"end_of_turn_confidence_threshold,omitempty"`
	// Eager end of turn confidence threshold (must be <= `end_of_turn_threshold`).
	EagerEndOfTurnConfidenceThreshold float64 `protobuf:"fixed64,4,opt,name=eager_end_of_turn_confidence_threshold,json=eagerEndOfTurnConfidenceThreshold,proto3" json:"eager_end_of_turn_confidence_threshold,omitempty"`
	...
	EndOfTurnTimeout *durationpb.Duration `protobuf:"bytes,5,opt,name=end_of_turn_timeout,json=endOfTurnTimeout,proto3" json:"end_of_turn_timeout,omitempty"`
	// Optional language code to improve transcription accuracy (e.g., "en", "es").
...
func (x *SpeechToTextStreamConfiguration) GetEndOfTurnConfidenceThreshold() float64 {
	if x != nil {
		return x.EndOfTurnConfidenceThreshold
	}
	return 0
}
...
func (x *SpeechToTextStreamConfiguration) GetEagerEndOfTurnConfidenceThreshold() float64 {
	if x != nil {
		return x.EagerEndOfTurnConfidenceThreshold
	}
	return 0
}
...
func (b0 SpeechToTextStreamConfiguration_builder) Build() *SpeechToTextStreamConfiguration {
	...
	x.Model = b.Model
	x.AudioFormat = b.AudioFormat
	x.EndOfTurnConfidenceThreshold = b.EndOfTurnConfidenceThreshold
	x.EagerEndOfTurnConfidenceThreshold = b.EagerEndOfTurnConfidenceThreshold
	x.EndOfTurnTimeout = b.EndOfTurnTimeout
	x.LanguageCode = b.LanguageCode
	return m0
}

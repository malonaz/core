...
type SpeechToTextStreamEndOfTurnConfiguration struct {
	...
	EagerThreshold float64 `protobuf:"fixed64,2,opt,name=eager_threshold,json=eagerThreshold,proto3" json:"eager_threshold,omitempty"`
...
func (b0 SpeechToTextStreamEndOfTurnConfiguration_builder) Build() *SpeechToTextStreamEndOfTurnConfiguration {
	...
	x.EagerThreshold = b.EagerThreshold
	x.Timeout = b.Timeout
	return m0
}

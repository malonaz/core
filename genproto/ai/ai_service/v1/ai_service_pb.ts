...
import type { ComputeUserStatsRequestSchema } from "./user_stats_pb";
import { file_malonaz_ai_ai_service_v1_user_stats } from "./user_stats_pb";
...
import type { UserStatsSchema } from "../../v1/user_stats_pb";
...
export const AiService: GenService<{
   ...
   * See: https://google.aip.dev/136 (Custom methods).
   *
   * @generated from rpc malonaz.ai.ai_service.v1.AiService.ComputeUserStats
   */
  computeUserStats: {
    methodKind: "unary";
    input: typeof ComputeUserStatsRequestSchema;

...
import type { CreateMessageRequestSchema, DeleteMessageRequestSchema, GetMessageRequestSchema, ListMessagesRequestSchema, ListMessagesResponseSchema, StreamMessageRequestSchema, StreamMessageResponseSchema, UpdateMessageRequestSchema } from "./message_pb";
...
export const AiService: GenService<{
   ...
   *
   * @generated from rpc malonaz.ai.ai_service.v1.AiService.StreamMessage
   */
  streamMessage: {
    methodKind: "server_streaming";
    input: typeof StreamMessageRequestSchema;
    output: typeof StreamMessageResponseSchema;
  },
}> = /*@__PURE__*/

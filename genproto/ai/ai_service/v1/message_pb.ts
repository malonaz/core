 ...
 *
 * @generated from message malonaz.ai.ai_service.v1.UndeleteMessageRequest
 */
export type UndeleteMessageRequest = Message<"malonaz.ai.ai_service.v1.UndeleteMessageRequest"> & {
  /**
 ...
 * @generated from message malonaz.ai.ai_service.v1.UndeleteMessageRequest
 */
export type UndeleteMessageRequestValid = Message<"malonaz.ai.ai_service.v1.UndeleteMessageRequest"> & {
  /**
   * The resource name of the deleted message to restore.
   * Format: organizations/{organization}/users/{user}/chats/{chat}/messages/{message}
   *
...
/**
 * Describes the message malonaz.ai.ai_service.v1.UndeleteMessageRequest.
 * Use `create(UndeleteMessageRequestSchema)` to create a new message.
 */
export const UndeleteMessageRequestSchema: GenMessage<UndeleteMessageRequest, {validType: UndeleteMessageRequestValid}> = /*@__PURE__*/

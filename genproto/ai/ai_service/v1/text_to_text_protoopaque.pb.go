...
type TextToTextConfiguration struct {
	...
	xxx_hidden_ImageConfig            *ImageGenerationConfig `protobuf:"bytes,6,opt,name=image_config,json=imageConfig,proto3"`
...
type TextToTextRequest struct {
	...
	xxx_hidden_ToolSets      *[]*v1.ToolSet           `protobuf:"bytes,7,rep,name=tool_sets,json=toolSets,proto3"`

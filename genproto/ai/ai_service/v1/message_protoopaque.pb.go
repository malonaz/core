...
type CreateMessageRequest struct {
	...
	xxx_hidden_Message      *v1.Message            `protobuf:"bytes,2,opt,name=message,proto3"`
	xxx_hidden_MessageId    string                 `protobuf:"bytes,3,opt,name=message_id,json=messageId,proto3"`
...
type MessageGenerationConfiguration struct {
	...
	xxx_hidden_StreamPartialToolCalls bool                          `protobuf:"varint,5,opt,name=stream_partial_tool_calls,json=streamPartialToolCalls,proto3"`
	xxx_hidden_ImageConfiguration     *ImageGenerationConfiguration `protobuf:"bytes,6,opt,name=image_configuration,json=imageConfiguration,proto3"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}
...
func (x *MessageGenerationConfiguration) GetImageConfiguration() *ImageGenerationConfiguration {
	if x != nil {
		return x.xxx_hidden_ImageConfiguration
	}
	return nil
}
...
func (x *MessageGenerationConfiguration) SetImageConfiguration(v *ImageGenerationConfiguration) {
	x.xxx_hidden_ImageConfiguration = v
}
...
func (x *MessageGenerationConfiguration) HasImageConfiguration() bool {
	...
	return x.xxx_hidden_ImageConfiguration != nil
}
...
func (x *MessageGenerationConfiguration) ClearImageConfiguration() {
	x.xxx_hidden_ImageConfiguration = nil
}
...
func (b0 MessageGenerationConfiguration_builder) Build() *MessageGenerationConfiguration {
	...
	x.xxx_hidden_ImageConfiguration = b.ImageConfiguration
	return m0
}

...
type UserStatsSnapshot struct {
	...
	Messages      *MessageStats `protobuf:"bytes,2,opt,name=messages,proto3" json:"messages,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MessageStats struct {
	...
	ModelBreakdowns []*ModelBreakdown `protobuf:"bytes,3,rep,name=model_breakdowns,json=modelBreakdowns,proto3" json:"model_breakdowns,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (b0 MessageStats_builder) Build() *MessageStats {
	...
	x.Count = b.Count
	x.Price = b.Price
	x.ModelBreakdowns = b.ModelBreakdowns
	return m0
}
...
type ModelBreakdown struct {
	...
	InputToken *ResourceConsumptionStats `protobuf:"bytes,4,opt,name=input_token,json=inputToken,proto3" json:"input_token,omitempty"`
	// Output tokens, excluding reasoning and image tokens.
	OutputToken *ResourceConsumptionStats `protobuf:"bytes,5,opt,name=output_token,json=outputToken,proto3" json:"output_token,omitempty"`
	// Output reasoning tokens.
	OutputReasoningToken *ResourceConsumptionStats `protobuf:"bytes,6,opt,name=output_reasoning_token,json=outputReasoningToken,proto3" json:"output_reasoning_token,omitempty"`
	// Input tokens served from the provider's cache.
	InputTokenCacheRead *ResourceConsumptionStats `protobuf:"bytes,7,opt,name=input_token_cache_read,json=inputTokenCacheRead,proto3" json:"input_token_cache_read,omitempty"`
	// Input tokens written to the provider's cache.
	InputTokenCacheWrite *ResourceConsumptionStats `protobuf:"bytes,8,opt,name=input_token_cache_write,json=inputTokenCacheWrite,proto3" json:"input_token_cache_write,omitempty"`
	// Input seconds, for audio models.
	InputSecond *ResourceConsumptionStats `protobuf:"bytes,9,opt,name=input_second,json=inputSecond,proto3" json:"input_second,omitempty"`
	// Output seconds, for audio models.
	OutputSecond *ResourceConsumptionStats `protobuf:"bytes,10,opt,name=output_second,json=outputSecond,proto3" json:"output_second,omitempty"`
	// Input characters, for models priced per character.
	InputCharacter *ResourceConsumptionStats `protobuf:"bytes,11,opt,name=input_character,json=inputCharacter,proto3" json:"input_character,omitempty"`
	// Input image tokens.
	InputImageToken *ResourceConsumptionStats `protobuf:"bytes,12,opt,name=input_image_token,json=inputImageToken,proto3" json:"input_image_token,omitempty"`
	// Output image tokens.
	OutputImageToken *ResourceConsumptionStats `protobuf:"bytes,13,opt,name=output_image_token,json=outputImageToken,proto3" json:"output_image_token,omitempty"`
	// Input image tokens served from the provider's cache.
	InputImageTokenCacheRead *ResourceConsumptionStats `protobuf:"bytes,14,opt,name=input_image_token_cache_read,json=inputImageTokenCacheRead,proto3" json:"input_image_token_cache_read,omitempty"`
	// Input image tokens written to the provider's cache.
	InputImageTokenCacheWrite *ResourceConsumptionStats `protobuf:"bytes,15,opt,name=input_image_token_cache_write,json=inputImageTokenCacheWrite,proto3" json:"input_image_token_cache_write,omitempty"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}

...
type Message struct {
	...
	xxx_hidden_Model       string                 `protobuf:"bytes,10,opt,name=model,proto3"`
	xxx_hidden_ModelUsage  *ModelUsage            `protobuf:"bytes,11,opt,name=model_usage,json=modelUsage,proto3"`
	xxx_hidden_Price       float64                `protobuf:"fixed64,12,opt,name=price,proto3"`
	xxx_hidden_Status      *status.Status         `protobuf:"bytes,13,opt,name=status,proto3"`
...
func (x *Message) GetModelUsage() *ModelUsage {
	if x != nil {
...
func (x *Message) GetPrice() float64 {
	if x != nil {
...
func (x *Message) SetUpdateTime(v *timestamppb.Timestamp) {
...
func (x *Message) SetEtag(v string) {
	x.xxx_hidden_Etag = v
}
...
func (x *Message) SetModel(v string) {
	x.xxx_hidden_Model = v
}

func (x *Message) SetModelUsage(v *ModelUsage) {
	x.xxx_hidden_ModelUsage = v
}

func (x *Message) SetPrice(v float64) {
...
func (x *Message) HasUpdateTime() bool {
	if x == nil {
		return false
	}
...
func (x *Message) HasModelUsage() bool {
	if x == nil {
		return false
	}
...
func (x *Message) ClearUpdateTime() {

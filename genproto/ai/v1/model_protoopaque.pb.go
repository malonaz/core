...
type Model struct {
	...
	xxx_hidden_Ttc              *TtcModelConfig        `protobuf:"bytes,9,opt,name=ttc,proto3"`
...
type TtcModelConfig struct {
	state                        protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ContextTokenLimit int32                  `protobuf:"varint,1,opt,name=context_token_limit,json=contextTokenLimit,proto3"`
	xxx_hidden_Pricing           *TtcModelPricing       `protobuf:"bytes,2,opt,name=pricing,proto3"`
	unknownFields                protoimpl.UnknownFields
	sizeCache                    protoimpl.SizeCache
}

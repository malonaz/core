...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_MESSAGE']._serialized_options = b'\352Av\n\026ai.malonaz.com/Message\022Iorganizations/{organization}/users/{user}/chats/{chat}/messages/{message}*\010messages2\007message\272H\350\004\032r\n\022system_role_blocks\022)SYSTEM messages can only have text blocks\0321this.role != 1 || this.blocks.all(b, has(b.text))\032\314\001\n\025assistant_role_blocks\022JASSISTANT messages can only have thought, text, tool_call, or image blocks\032gthis.role != 2 || this.blocks.all(b, has(b.thought) || has(b.text) || has(b.tool_call) || has(b.image))\032\244\001\n\020user_role_blocks\022:USER messages can only have text, image or document blocks\032Tthis.role != 3 || this.blocks.all(b, has(b.text) || has(b.image) || has(b.document))\032|\n\020tool_role_blocks\022.TOOL messages can only have tool_result blocks\0328this.role != 4 || this.blocks.all(b, has(b.tool_result))\322\246\004\000\202\366,$d96e0fa8-568e-420f-bdb2-3c133ef3a50f'
  _globals['_BLOCK']._loaded_options = None
  _globals['_BLOCK']._serialized_options = b'\272H\217\002\032\214\002\n)block_content_required_when_signature_set\022)content is required when signature is set\032\263\001this.signature == \'\' || has(this.thought) || has(this.text) || has(this.tool_call) || has(this.partial_tool_call) || has(this.tool_result) || has(this.image) || has(this.document)'
  ...
  _globals['_DOCUMENT'].oneofs_by_name['source']._loaded_options = None
  _globals['_DOCUMENT'].oneofs_by_name['source']._serialized_options = b'\272H\002\010\001'
  _globals['_DOCUMENT']._loaded_options = None
  _globals['_DOCUMENT']._serialized_options = b'\272H{\032y\n%document_requires_media_type_for_data\022&media_type is required when using data\032(!has(this.data) || this.media_type != \'\''
  _globals['_REASONINGEFFORT']._serialized_start=3132
  _globals['_REASONINGEFFORT']._serialized_end=3349
  _globals['_ROLE']._serialized_start=3351
  _globals['_ROLE']._serialized_end=3446
  _globals['_IMAGEQUALITY']._serialized_start=3448
  _globals['_IMAGEQUALITY']._serialized_end=3564
  _globals['_MESSAGE']._serialized_start=351
  _globals['_MESSAGE']._serialized_end=1997
  _globals['_MESSAGE_LABELSENTRY']._serialized_start=1112
  _globals['_MESSAGE_LABELSENTRY']._serialized_end=1157
  _globals['_MESSAGE_ANNOTATIONSENTRY']._serialized_start=1159
  _globals['_MESSAGE_ANNOTATIONSENTRY']._serialized_end=1209
  _globals['_BLOCK']._serialized_start=2000
  _globals['_BLOCK']._serialized_end=2646
  _globals['_IMAGE']._serialized_start=2649
  _globals['_IMAGE']._serialized_end=2905
  _globals['_DOCUMENT']._serialized_start=2908

...
type ToolSet struct {
	...
	DiscoveryTool *v1.Tool `protobuf:"bytes,1,opt,name=discovery_tool,json=discoveryTool,proto3" json:"discovery_tool,omitempty"`
	...
	ToolNameToDiscoverTime map[string]*timestamppb.Timestamp `protobuf:"bytes,3,rep,name=tool_name_to_discover_time,json=toolNameToDiscoverTime,proto3" json:"tool_name_to_discover_time,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *ToolSet) GetToolNameToDiscoverTime() map[string]*timestamppb.Timestamp {
	if x != nil {
		return x.ToolNameToDiscoverTime
	}
	return nil
}
...
func (b0 ToolSet_builder) Build() *ToolSet {
	...
	x.Tools = b.Tools
	x.ToolNameToDiscoverTime = b.ToolNameToDiscoverTime
	return m0
}

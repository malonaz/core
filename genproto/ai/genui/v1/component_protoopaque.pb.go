...
func (x *Component) GetStat() *Stat {
	if x != nil {
		if x, ok := x.xxx_hidden_Component.(*component_Stat); ok {
			return x.Stat
		}
	}
	return nil
...
func (x *Component) GetResourceTree() *ResourceTree {
	if x != nil {
		if x, ok := x.xxx_hidden_Component.(*component_ResourceTree); ok {
...
func (x *Component) SetStat(v *Stat) {
	...
	x.xxx_hidden_Component = &component_Stat{v}
}
...
func (x *Component) SetResourceTree(v *ResourceTree) {
	if v == nil {
		x.xxx_hidden_Component = nil
		return
	}
	x.xxx_hidden_Component = &component_ResourceTree{v}
}
...
func (x *Component) HasStat() bool {
	...
	_, ok := x.xxx_hidden_Component.(*component_Stat)
	return ok
}
...
func (x *Component) HasResourceTree() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Component.(*component_ResourceTree)
	return ok
}
...
func (x *Component) ClearStat() {
	if _, ok := x.xxx_hidden_Component.(*component_Stat); ok {
		x.xxx_hidden_Component = nil
	}
}
...
func (x *Component) ClearResourceTree() {
	if _, ok := x.xxx_hidden_Component.(*component_ResourceTree); ok {
		x.xxx_hidden_Component = nil
	}
}
...
func (x *Component) WhichComponent() case_Component_Component {
	...
	case *component_ResourceTree:
		return Component_ResourceTree_case
...
func (b0 Component_builder) Build() *Component {
	...
	if b.Stat != nil {
		x.xxx_hidden_Component = &component_Stat{b.Stat}
	}
	if b.ActionRow != nil {
		x.xxx_hidden_Component = &component_ActionRow{b.ActionRow}
	}
	if b.ResourceTree != nil {
		x.xxx_hidden_Component = &component_ResourceTree{b.ResourceTree}
	}
	if b.Choice != nil {
...
type component_ResourceTree struct {
	// A hierarchy of related resources rendered as an indented tree.
	ResourceTree *ResourceTree `protobuf:"bytes,17,opt,name=resource_tree,json=resourceTree,proto3,oneof"`
}

...
type KeyValueListItem struct {
	...
	Tone          Tone `protobuf:"varint,4,opt,name=tone,proto3,enum=malonaz.ai.genui.v1.Tone" json:"tone,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type TimelineEntry struct {
	...
	Tone          Tone `protobuf:"varint,5,opt,name=tone,proto3,enum=malonaz.ai.genui.v1.Tone" json:"tone,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Stat struct {
	...
	DeltaTone Tone `protobuf:"varint,4,opt,name=delta_tone,json=deltaTone,proto3,enum=malonaz.ai.genui.v1.Tone" json:"delta_tone,omitempty"`
...
func (x *ActionRowAction) GetOpenPath() string {
	if x != nil {
		if x, ok := x.Action.(*ActionRowAction_OpenPath); ok {
			return x.OpenPath
		}
	}
	return ""
...
func (x *ActionRowAction) SetOpenPath(v string) {
	x.Action = &ActionRowAction_OpenPath{v}
}
...
func (x *ActionRowAction) HasOpenPath() bool {
	...
	_, ok := x.Action.(*ActionRowAction_OpenPath)
	return ok
}
...
func (x *ActionRowAction) ClearOpenPath() {
	if _, ok := x.Action.(*ActionRowAction_OpenPath); ok {
		x.Action = nil
	}
}
...
func (b0 ActionRowAction_builder) Build() *ActionRowAction {
	...
	if b.OpenPath != nil {
		x.Action = &ActionRowAction_OpenPath{*b.OpenPath}
	}
	return m0
}
...
func (x case_ActionRowAction_Action) String() string {
	md := file_malonaz_ai_genui_v1_content_proto_msgTypes[13].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var file_malonaz_ai_genui_v1_content_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_malonaz_ai_genui_v1_content_proto_goTypes = []any{
	...
	(*ActionRow)(nil),             // 17: malonaz.ai.genui.v1.ActionRow
	(*ActionRowAction)(nil),       // 18: malonaz.ai.genui.v1.ActionRowAction
...
var file_malonaz_ai_genui_v1_content_proto_depIdxs = []int32{
	...
	19, // 3: malonaz.ai.genui.v1.TimelineEntry.time:type_name -> google.protobuf.Timestamp
	...
	18, // 14: malonaz.ai.genui.v1.ActionRow.actions:type_name -> malonaz.ai.genui.v1.ActionRowAction
...
func file_malonaz_ai_genui_v1_content_proto_init() {
	...
	file_malonaz_ai_genui_v1_content_proto_msgTypes[13].OneofWrappers = []any{

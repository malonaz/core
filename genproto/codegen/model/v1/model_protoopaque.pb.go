...
func (x *Join) GetAggregate() *Aggregate {
	if x != nil {
		if x, ok := x.xxx_hidden_Selector.(*join_Aggregate); ok {
			return x.Aggregate
		}
	}
	return nil
...
func (x *Join) SetAggregate(v *Aggregate) {
	...
	x.xxx_hidden_Selector = &join_Aggregate{v}
}
...
func (x *Join) HasAggregate() bool {
	...
	_, ok := x.xxx_hidden_Selector.(*join_Aggregate)
	return ok
}
...
func (x *Join) ClearAggregate() {
	if _, ok := x.xxx_hidden_Selector.(*join_Aggregate); ok {
		x.xxx_hidden_Selector = nil
	}
}
...
func (b0 Join_builder) Build() *Join {
	...
	if b.Aggregate != nil {
		x.xxx_hidden_Selector = &join_Aggregate{b.Aggregate}
	}
	return m0
}
...
type Aggregate struct {
	state               protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Function Aggregate_Function     `protobuf:"varint,1,opt,name=function,proto3,enum=malonaz.codegen.model.v1.Aggregate_Function"`

...
// @generated from file malonaz/codegen/nats/v1/event.proto (package malonaz.codegen.nats.v1, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file malonaz/codegen/nats/v1/event.proto.
 */
export const file_malonaz_codegen_nats_v1_event: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_descriptor, file_malonaz_nats_v1_stream]);
...
export const EventOptionsSchema: GenMessage<EventOptions, {validType: EventOptionsValid}> = /*@__PURE__*/
  messageDesc(file_malonaz_codegen_nats_v1_event, 0);
...
export const stream: GenExtension<ServiceOptions, StreamOptions[]> = /*@__PURE__*/
  extDesc(file_malonaz_codegen_nats_v1_event, 0);
...
export const event: GenExtension<MessageOptions, EventOptions> = /*@__PURE__*/
  extDesc(file_malonaz_codegen_nats_v1_event, 1);

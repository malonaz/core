...
type Label struct {
	...
	xxx_hidden_KeyVariables []string               `protobuf:"bytes,2,rep,name=key_variables,json=keyVariables,proto3"`
...
func (x *Label) GetKeyVariables() []string {
	if x != nil {
		return x.xxx_hidden_KeyVariables
	}
	return nil
}
...
func (b0 Label_builder) Build() *Label {
	...
	x.xxx_hidden_KeyVariables = b.KeyVariables

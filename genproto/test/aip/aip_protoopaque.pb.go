...
type Resource struct {
	...
	xxx_hidden_CreateTimestamp   *timestamppb.Timestamp `protobuf:"bytes,20,opt,name=create_timestamp,json=createTimestamp,proto3"`
	xxx_hidden_UpdateTime        *timestamppb.Timestamp `protobuf:"bytes,21,opt,name=update_time,json=updateTime,proto3"`
	xxx_hidden_Tags              []string               `protobuf:"bytes,13,rep,name=tags,proto3"`
	xxx_hidden_Items             *[]*NestedResource     `protobuf:"bytes,14,rep,name=items,proto3"`
	...
	xxx_hidden_Counts            map[string]int64       `protobuf:"bytes,16,rep,name=counts,proto3" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
type NestedResource struct {
	...
	xxx_hidden_State         MyEnum                 `protobuf:"varint,5,opt,name=state,proto3,enum=test.aip.v1.MyEnum"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}

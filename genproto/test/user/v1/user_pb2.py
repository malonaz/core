...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_USER']._serialized_options = b'\352AT\n\032user.test.malonaz.com/User\022)organizations/{organization}/users/{user}*\005users2\004user\322\246\004\013\022\005user_\032\002id\212\221$I\n&malonaz.test.user.user_service.v1.user\022\t\n\007created\032\t\n\007updated\"\t\n\007deleted'

...
func (x *Book) GetShelfGenre() ShelfGenre {
	if x != nil {
		return x.xxx_hidden_ShelfGenre
	}
...
type Dummy struct {
	state                 protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Subtotal   *money.Money           `protobuf:"bytes,1,opt,name=subtotal,proto3"`
	xxx_hidden_Tax        *money.Money           `protobuf:"bytes,2,opt,name=tax,proto3"`
	...
	xxx_hidden_Rate       float64                `protobuf:"fixed64,5,opt,name=rate,proto3"`
	xxx_hidden_Active     bool                   `protobuf:"varint,6,opt,name=active,proto3"`
	xxx_hidden_ExpireTime *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=expire_time,json=expireTime,proto3"`
	xxx_hidden_Duration   *durationpb.Duration   `protobuf:"bytes,8,opt,name=duration,proto3"`
	...
	xxx_hidden_Adjustment *DummyAdjustment       `protobuf:"bytes,12,opt,name=adjustment,proto3"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
type DummyAdjustment struct {
	state           protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Kind isDummyAdjustment_Kind `protobuf_oneof:"kind"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *DummyAdjustment) GetAmount() *money.Money {
	if x != nil {
		if x, ok := x.xxx_hidden_Kind.(*dummyAdjustment_Amount); ok {
			return x.Amount
		}
	}
	return nil
...
func (x *DummyAdjustment) GetPercentage() float64 {
	if x != nil {
		if x, ok := x.xxx_hidden_Kind.(*dummyAdjustment_Percentage); ok {
			return x.Percentage
		}
	}
	return 0
...
func (x *DummyAdjustment) SetAmount(v *money.Money) {
	...
	x.xxx_hidden_Kind = &dummyAdjustment_Amount{v}
}

func (x *DummyAdjustment) SetPercentage(v float64) {
	x.xxx_hidden_Kind = &dummyAdjustment_Percentage{v}
}
...
func (x *DummyAdjustment) HasAmount() bool {
	...
	_, ok := x.xxx_hidden_Kind.(*dummyAdjustment_Amount)
	return ok
}
...
func (x *DummyAdjustment) HasPercentage() bool {
	...
	_, ok := x.xxx_hidden_Kind.(*dummyAdjustment_Percentage)
	return ok
}
...
func (x *DummyAdjustment) ClearAmount() {
	if _, ok := x.xxx_hidden_Kind.(*dummyAdjustment_Amount); ok {
		x.xxx_hidden_Kind = nil
	}
}

func (x *DummyAdjustment) ClearPercentage() {
	if _, ok := x.xxx_hidden_Kind.(*dummyAdjustment_Percentage); ok {
		x.xxx_hidden_Kind = nil
	}
}
...
func (b0 DummyAdjustment_builder) Build() *DummyAdjustment {
	...
	_, _ = b, x
	if b.Amount != nil {
		x.xxx_hidden_Kind = &dummyAdjustment_Amount{b.Amount}
	}
	if b.Percentage != nil {
		x.xxx_hidden_Kind = &dummyAdjustment_Percentage{*b.Percentage}
	}
	return m0
}
...
const file_malonaz_test_library_v1_book_proto_rawDesc = "" +
	...
	"\x11shelf_external_id\x18\r \x01(\tB8\xe0A\x03\xba\xea\x0f1 \x01B-\x12\vexternal_id\n" +
	"\x1elibrary.test.malonaz.com/ShelfR\x0fshelfExternalId\x12v\n" +
	"\vshelf_genre\x18\x0e \x01(\x0e2#.malonaz.test.library.v1.ShelfGenreB0\xe0A\x03\xba\xea\x0f)B'\x12\x05genre\n" +
	"\x1elibrary.test.malonaz.com/ShelfR\n" +
	"shelfGenre\x1a9\n" +

...
const file_malonaz_test_library_v1_book_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\xfc\x01\xeaAg\n" +
	"\x1dlibrary.test.malonaz.com/Book\x129organizations/{organization}/shelves/{shelf}/books/{book}*\x05books2\x04bookҦ\x04\x00\x8a\x91$b\n" +

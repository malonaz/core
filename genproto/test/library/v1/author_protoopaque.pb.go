...
func (x *Author) Reset() {
	*x = Author{}
	mi := &file_malonaz_test_library_v1_author_proto_msgTypes[0]
...
func (x *AuthorMetadata) Reset() {
	*x = AuthorMetadata{}
	mi := &file_malonaz_test_library_v1_author_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_malonaz_test_library_v1_author_proto protoreflect.FileDescriptor
...
const file_malonaz_test_library_v1_author_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\xa4\x02\xeaAa\n" +
	"\x1flibrary.test.malonaz.com/Author\x12-organizations/{organization}/authors/{author}*\aauthors2\x06authorҦ\x04\t\n" +
	"\alibrary\x9a\xf3-\xae\x01\n" +
	"\x10\n" +
	"\fdisplay_name\x10\x01\n" +
	"\x13\n" +
	"\remail_address\x10\x02\x18\x01\n" +
	"\x12\n" +
	"\fphone_number\x10\x02\x18\x02\n" +
	"\x15\n" +
	"\x0femail_addresses\x10\x03\x18\x01\n" +
	"\x13\n" +
...
func file_malonaz_test_library_v1_author_proto_init() {
	if File_malonaz_test_library_v1_author_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_malonaz_test_library_v1_author_proto_goTypes,
		DependencyIndexes: file_malonaz_test_library_v1_author_proto_depIdxs,
		MessageInfos:      file_malonaz_test_library_v1_author_proto_msgTypes,
	}.Build()
	File_malonaz_test_library_v1_author_proto = out.File
	file_malonaz_test_library_v1_author_proto_goTypes = nil
	file_malonaz_test_library_v1_author_proto_depIdxs = nil
}

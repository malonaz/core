...
type UpdateAuthorRequest struct {
	...
	Author *v1.Author `protobuf:"bytes,1,opt,name=author,proto3" json:"author,omitempty"`
...
type BatchCreateAuthorsRequest struct {
	...
	Requests []*CreateAuthorRequest `protobuf:"bytes,2,rep,name=requests,proto3" json:"requests,omitempty"`

...
type CreateNoteRequest struct {
	...
	// The note to create.
	Note *v1.Note `protobuf:"bytes,3,opt,name=note,proto3" json:"note,omitempty"`
...
type ImportNotesRequest struct {
	...
	//
	//	*ImportNotesRequest_InlineSource_
	Source isImportNotesRequest_Source `protobuf_oneof:"source"`
...
func (x *ImportNotesRequest) GetSource() isImportNotesRequest_Source {
	if x != nil {
		return x.Source
	}
	return nil
...
func (x *ImportNotesRequest) GetInlineSource() *ImportNotesRequest_InlineSource {
	if x != nil {
		if x, ok := x.Source.(*ImportNotesRequest_InlineSource_); ok {
...
func (x *ImportNotesRequest) SetInlineSource(v *ImportNotesRequest_InlineSource) {
	...
	x.Source = &ImportNotesRequest_InlineSource_{v}
}
...
func (x *ImportNotesRequest) HasInlineSource() bool {
	...
	_, ok := x.Source.(*ImportNotesRequest_InlineSource_)
	return ok
}
...
func (x *ImportNotesRequest) ClearInlineSource() {
	if _, ok := x.Source.(*ImportNotesRequest_InlineSource_); ok {
		x.Source = nil
	}
}
...
func (b0 ImportNotesRequest_builder) Build() *ImportNotesRequest {
	...
	if b.InlineSource != nil {
		x.Source = &ImportNotesRequest_InlineSource_{b.InlineSource}
	}
	x.ValidateOnly = b.ValidateOnly
	return m0
}

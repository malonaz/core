...
export type JobAttempt = Message<"malonaz.scheduler.v1.JobAttempt"> & {
   ...
   *
   * @generated from field: bool manual = 7;
   */
  manual: boolean;
};

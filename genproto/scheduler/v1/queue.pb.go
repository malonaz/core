...
type Queue struct {
	...
	State QueueState `protobuf:"varint,5,opt,name=state,proto3,enum=malonaz.scheduler.v1.QueueState" json:"state,omitempty"`
	// The execution policy of every job in the queue.
	Policy *QueuePolicy `protobuf:"bytes,6,opt,name=policy,proto3" json:"policy,omitempty"`
	...
	Handlers []*Handler `protobuf:"bytes,7,rep,name=handlers,proto3" json:"handlers,omitempty"`
	// The queue's backlog, computed when the queue is read.
	Stats         *QueueStats `protobuf:"bytes,8,opt,name=stats,proto3" json:"stats,omitempty"`
...
type QueuePolicy struct {
	...
	RetryBackoff *RetryBackoff `protobuf:"bytes,3,opt,name=retry_backoff,json=retryBackoff,proto3" json:"retry_backoff,omitempty"`

...
type Field struct {
	...
	xxx_hidden_Rule isField_Rule           `protobuf_oneof:"rule"`
...
func (x *Field) GetEmailAddress() bool {
	if x != nil {
		if x, ok := x.xxx_hidden_Rule.(*field_EmailAddress); ok {
...
func (x *Field) GetPhoneNumber() bool {
	if x != nil {
		if x, ok := x.xxx_hidden_Rule.(*field_PhoneNumber); ok {
...
func (x *Field) SetEmailAddress(v bool) {
	x.xxx_hidden_Rule = &field_EmailAddress{v}
}

func (x *Field) SetPhoneNumber(v bool) {
	x.xxx_hidden_Rule = &field_PhoneNumber{v}
}
...
func (x *Field) HasEmailAddress() bool {
	...
	_, ok := x.xxx_hidden_Rule.(*field_EmailAddress)
	return ok
}
...
func (x *Field) HasPhoneNumber() bool {
	...
	_, ok := x.xxx_hidden_Rule.(*field_PhoneNumber)
	return ok
}
...
func (x *Field) ClearEmailAddress() {
	if _, ok := x.xxx_hidden_Rule.(*field_EmailAddress); ok {
		x.xxx_hidden_Rule = nil
	}
}

func (x *Field) ClearPhoneNumber() {
	if _, ok := x.xxx_hidden_Rule.(*field_PhoneNumber); ok {
		x.xxx_hidden_Rule = nil
	}
}
...
func (b0 Field_builder) Build() *Field {
	...
	if b.EmailAddress != nil {
		x.xxx_hidden_Rule = &field_EmailAddress{*b.EmailAddress}
	}
	if b.PhoneNumber != nil {
		x.xxx_hidden_Rule = &field_PhoneNumber{*b.PhoneNumber}
	}
	return m0
}

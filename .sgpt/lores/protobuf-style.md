---
title: Protobuf style guide (core)
description: 'Protobuf style guide: AIP resource patterns, naming, codegen model options, field behaviors, buf.validate validation, comments.'
labels:
    lang: protobuf
    repo: core
    topic: style-guide
